...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.player_index = 0
        self.player_jump = pygame.image.load(graphics_path+'Player/jump.png').convert_alpha()

        self.image = self.player_walk[self.player_index]
        self.rect = self.image.get_rect(midbottom = (80,300))
        self.gravity = 0

        self.jump_soud = pygame.mixer.Sound('./UltimatePygameIntro/audio/jump.mp3')
        self.jump_soud.set_volume(0.2)
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self,type):
        ...
        if type == 'fly':
            fly_1   = pygame.image.load(graphics_path+'Fly/Fly1.png').convert_alpha()
            fly_2   = pygame.image.load(graphics_path+'Fly/Fly2.png').convert_alpha()
            self.frames = [fly_1, fly_2]
            y_pos = 210
        else:
            snail_1 = pygame.image.load(graphics_path+'snail/snail1.png').convert_alpha()
            snail_2 = pygame.image.load(graphics_path+'snail/snail2.png').convert_alpha()
